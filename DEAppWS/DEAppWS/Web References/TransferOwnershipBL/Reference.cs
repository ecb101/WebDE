...
namespace DEAppWS.TransferOwnershipBL {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="TransferOwnershipBLSoap", Namespace="http://tempuri.org/")]
    public partial class TransferOwnershipBL : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback updateReviewerOperationCompleted;
        ...
        public TransferOwnershipBL() {
            this.Url = global::DEAppWS.Properties.Settings.Default.DEAppWS_TransferOwnershipBL_TransferOwnershipBL;
        ...
        /// <remarks/>
        public event updateReviewerCompletedEventHandler updateReviewerCompleted;
        ...
        public System.Data.DataSet selectBatches(string status) {
        ...
        /// <remarks/>
        public void selectBatchesAsync(string status) {
            this.selectBatchesAsync(status, null);
        }
        
        /// <remarks/>
        public void selectBatchesAsync(string status, object userState) {
            ...
            this.InvokeAsync("selectBatches", new object[] {
                        status}, this.selectBatchesOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/updateOperator", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        ...
        /// <remarks/>
        public void updateOperatorAsync(string batCtrlNum, string Operator, string systemUserName) {
            this.updateOperatorAsync(batCtrlNum, Operator, systemUserName, null);
        }
        
        /// <remarks/>
        public void updateOperatorAsync(string batCtrlNum, string Operator, string systemUserName, object userState) {
            ...
            this.InvokeAsync("updateOperator", new object[] {
                        batCtrlNum,
                        Operator,
                        systemUserName}, this.updateOperatorOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/updateReviewer", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public bool updateReviewer(string batCtrlNum, string Reviewer, string systemUserName) {
            object[] results = this.Invoke("updateReviewer", new object[] {
                        batCtrlNum,
                        Reviewer,
                        systemUserName});
            return ((bool)(results[0]));
        ...
        /// <remarks/>
        public void updateReviewerAsync(string batCtrlNum, string Reviewer, string systemUserName) {
            this.updateReviewerAsync(batCtrlNum, Reviewer, systemUserName, null);
        }
        
        /// <remarks/>
        public void updateReviewerAsync(string batCtrlNum, string Reviewer, string systemUserName, object userState) {
            if ((this.updateReviewerOperationCompleted == null)) {
                this.updateReviewerOperationCompleted = new System.Threading.SendOrPostCallback(this.OnupdateReviewerOperationCompleted);
            }
            this.InvokeAsync("updateReviewer", new object[] {
                        batCtrlNum,
                        Reviewer,
                        systemUserName}, this.updateReviewerOperationCompleted, userState);
        }
        
        private void OnupdateReviewerOperationCompleted(object arg) {
            if ((this.updateReviewerCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.updateReviewerCompleted(this, new updateReviewerCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.3053")]
    public delegate void updateReviewerCompletedEventHandler(object sender, updateReviewerCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.3053")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class updateReviewerCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal updateReviewerCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
