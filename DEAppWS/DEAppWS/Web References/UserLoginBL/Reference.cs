...
namespace DEAppWS.UserLoginBL {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="UserLoginBLSoap", Namespace="http://tempuri.org/")]
    public partial class UserLoginBL : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback selectPasswordOperationCompleted;
        ...
        /// <remarks/>
        public UserLoginBL() {
            this.Url = global::DEAppWS.Properties.Settings.Default.DEAppWS_UserLoginBL_UserLoginBL;
        ...
        /// <remarks/>
        public event selectPasswordCompletedEventHandler selectPasswordCompleted;
        ...
        public System.Data.DataSet validateLogin(string userID, string password, string siteID) {
        ...
        /// <remarks/>
        public void validateLoginAsync(string userID, string password, string siteID) {
            this.validateLoginAsync(userID, password, siteID, null);
        }
        
        /// <remarks/>
        public void validateLoginAsync(string userID, string password, string siteID, object userState) {
            ...
            this.InvokeAsync("validateLogin", new object[] {
                        userID,
                        password,
                        siteID}, this.validateLoginOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void UpdatePasswordAsync(string userID, string password) {
            this.UpdatePasswordAsync(userID, password, null);
        }
        
        /// <remarks/>
        public void UpdatePasswordAsync(string userID, string password, object userState) {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/selectPassword", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string selectPassword(string userID) {
            object[] results = this.Invoke("selectPassword", new object[] {
                        userID});
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void selectPasswordAsync(string userID) {
            this.selectPasswordAsync(userID, null);
        }
        
        /// <remarks/>
        public void selectPasswordAsync(string userID, object userState) {
            if ((this.selectPasswordOperationCompleted == null)) {
                this.selectPasswordOperationCompleted = new System.Threading.SendOrPostCallback(this.OnselectPasswordOperationCompleted);
            }
            this.InvokeAsync("selectPassword", new object[] {
                        userID}, this.selectPasswordOperationCompleted, userState);
        }
        
        private void OnselectPasswordOperationCompleted(object arg) {
            if ((this.selectPasswordCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.selectPasswordCompleted(this, new selectPasswordCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.3053")]
    public delegate void selectPasswordCompletedEventHandler(object sender, selectPasswordCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.3053")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class selectPasswordCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal selectPasswordCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
