...
namespace DEAppWS
{
    public partial class frmMatch : frmDEQABase
    {
        public frmMatch(CommonEnum.FormMode formMode, string MXXDatabase, string MXXOwnerKey, string MXXSCAC, string MXXOwnerCode, Form parent)
